...
@section('title',
    'Sprout Specialty T-Shirt Order
    Form')

@section('content')

    @include('frontend.components.form_header', [
        'title' => 'Sprout Specialty T-Shirt Order Form',
        'text' =>
    ...
    <section class="form-section form-section-gradient">
        <div class="container">
            <div class="site_form site_form_standardSproutTShirtOrder">
                <form id="specialtySproutTShirtOrderForm" method="POST"
                    action="{{ route('form.submitSpecialtyTShirtOrder') }}" novalidate>
                    @csrf
                    <div class="form-wrapper">
                        ...
                        <div class="form-left">
                            ...
                            <div class="form-grid">
                                ...
                                {{-- Theme/Holiday Checkboxes using Component --}}
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const form = document.getElementById('specialtySproutTShirtOrderForm');
